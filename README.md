...
This site was built with Gatsby React based framework. You may find the instructions below in order to start a local server, and start developing.
...
2. **Components**
  ...
  They are as follows:
    ...
    - ```header.js``` is outdated and not used. (please remove).
